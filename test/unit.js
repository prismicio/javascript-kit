...
it('Link should support target', function() {
  ...
  var jsonObject = JSON.parse(jsonString);
  var text = Prismic.Fragments.initField(jsonObject);
  assert.equal(text.asHtml(getLinkResolver()), '<a target="_blank" href="https://prismic.io">https://prismic.io</a>');
});
...
it('Link in StructuredText should support target', function() {
  ...
  var jsonObject = JSON.parse(jsonString);
  var text = Prismic.Fragments.initField(jsonObject);
  assert.equal(text.asHtml(getLinkResolver()), '<p>description <a target="_blank" href="https://google.com">link</a> description</p>');
});
